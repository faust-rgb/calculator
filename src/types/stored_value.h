...
// Forward declaration for matrix types
namespace matrix {
...
struct StoredValue {
    ...
    mymath::complex<Scalar> complex;       ///< 复数值
    ...
    // Matrix storage - use shared_ptr to avoid header dependency
    std::shared_ptr<matrix::Matrix> matrix_ptr;
