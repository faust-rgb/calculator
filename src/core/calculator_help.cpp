...
std::string build_help_topic(const std::string& topic) {
    ...
    if (topic == "functions") {
        ...
        "  Numeric:       abs sign floor ceil round trunc min max clamp sum mean avg median mode percentile quartile var std skewness kurtosis factorial nCr binom nPr fib is_prime next_prime prev_prime prime_pi euler_phi mobius rand randn randint\n"
