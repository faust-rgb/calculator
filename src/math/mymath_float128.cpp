...
// ============================================================================
//
// 本文件实现了 128 位高精度浮点数（float128_t）的数学运算。
// 使用双倍精度技术（double-double arithmetic），通过两个 long double
// 表示更高精度的数值，提供约 106 位有效数字。
//
// 主要功能包括：
// - 基本算术运算（加减乘除）
// - 误差自由变换（Error-Free Transformation）
// - Kahan 补偿求和算法
// - 高精度数学函数（sin, cos, exp, ln 等）
//
// 技术细节：
// - 使用 Dekker 算法进行乘法分解
// - 使用 Kahan 求和减少累积误差
// - 支持 FMA（Fused Multiply-Add）硬件加速
//
// 相关文件：
// - mymath_float128.h: float128_t 类型定义
// - mymath.h: 标量类型别名和函数声明
// ============================================================================
