// ============================================================================
// Script Feature Tests Implementation
// ============================================================================
...
static void test_script_match_case(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_for_in_list(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_for_in_matrix(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_for_in_string(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_list_operations(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_dict_operations(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_logical_operators(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_matrix_indexing(int& passed, int& failed) {
    Calculator calc;
    std::string output;
...
static void test_script_advanced_parser_features(int& passed, int& failed) {
    Calculator calc;
    std::string output;
